...
pid_t pid_controller_current_Iq = {.P=30.0f,.I=1.0f,.D=PID_D,.output_ramp=PID_RAMP,.limit=PID_LIMIT,.error_prev=0,.output_prev=0,.integral_prev=0};
pid_t pid_controller_current_Id = {.P=30.0f,.I=1.0f,.D=PID_D,.output_ramp=PID_RAMP,.limit=PID_LIMIT,.error_prev=0,.output_prev=0,.integral_prev=0};
pid_t pid_controller_current_OCP = {.P=2.0f,.I=0.05f,.D=PID_D,.output_ramp=PID_RAMP,.limit=PID_LIMIT,.error_prev=0,.output_prev=0,.integral_prev=0};
...
int main(void)
{
  ...
  HAL_GPIO_WritePin(Motor_Enable_GPIO_Port,Motor_Enable_Pin,GPIO_PIN_SET);
  setPhaseVoltage(2,0,_electricalAngle(M_PI*0.0f,pole_pairs),TIM1);
  HAL_Delay(3000);
